...
function goTag(e) {
  ...
  var openUrl = "./imageTag.html?urlId=" + urlId;
...
function initTr(item) {
  ...
  if (item.checked) {
    ...
    content +=
      "<td><button onclick='goTag(this)' class='btn btn-info'>Check</button><button onclick='handleDelete(this)' class='btn btn-danger' type='button'>Delete</button></td>";
  } else {
    content +=
      "<td><button onclick='goTag(this)' class='btn btn-info'>Tags</button><button onclick='handleDelete(this)' class='btn btn-danger' type='button'>Delete</button></td>";
  }
  content += "</tr>";
  return content;
}
